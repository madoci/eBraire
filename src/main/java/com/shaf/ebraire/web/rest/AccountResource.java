...
import com.shaf.ebraire.service.dto.PasswordChangeDTO;
...
public class AccountResource {
    ...
    public void registerCustomer(@Valid @RequestBody ManagedCustomerVM managedCustomerVM) {
        ...
        User user = userService.registerUser(new UserDTO(managedCustomerVM.getUser()), managedCustomerVM.getPassword(), managedCustomerVM.getAddress());
        mailService.sendActivationEmail(user);
    }
